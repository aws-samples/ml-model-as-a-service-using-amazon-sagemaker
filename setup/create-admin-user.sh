...
USERNAME=$1
if [[ -z "$USERNAME" ]]; then
    echo "No user name is provided, default username: admin-user will be used to create SaaS admin user" 
    USERNAME="admin-user"
fi
...
echo "Please use admin username: $USERNAME and password: Mlaa\$1234 to login to Control Plane admin site URL: https://$ADMIN_SITE_URL"